...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("images/UI/loli.jpeg"))
        # 图片读取进程
        ...
        self.model = self.model_load(weights="best.pt",
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        self.left_img.setPixmap(QPixmap("images/UI/1.jpeg"))
        self.right_img.setPixmap(QPixmap("images/UI/2.jpeg"))
    ...
    ***检测图片***
    ...
    def reset_vid(self):
        self.webcam_detection_btn.setEnabled(True)
        self.mp4_detection_btn.setEnabled(True)
        self.vid_img.setPixmap(QPixmap("images/UI/loli.jpeg"))
        self.vid_source = '0'
        self.webcam = True
